...
export default function AdminUploadPage() {
  ...
  const handleFileChange = async (field: 'coverFile' | 'audioFile', file: File | null) => {
    if (!file) {
    ...
    try {
      ...
      setUploadMessage(error instanceof Error ? error.message : 'File validation failed')
    }
  }
  ...
  const uploadToCloudinary = async (file: File, resourceType: 'image' | 'video'): Promise<string> => {
    ...
    formData.append('upload_preset', process.env.NEXT_PUBLIC_CLOUDINARY_UPLOAD_PRESET || 'sangeetx_preset')
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Upload New Song</h1>
