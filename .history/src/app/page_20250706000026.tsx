...
import { mockGenres, getPopularGenres } from '@/data/genres'
...
export default function HomePage() {
  ...
  const [isRepeating, setIsRepeating] = useState<'none' | 'one' | 'all'>('none')
          ...
          <div className="px-4 py-12 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="mt-6 text-xl text-purple-100">
                Explore millions of songs, create playlists, and find your new favorite artists
              </p>
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {popularSongs.slice(0, 6).map((song) => (
                  <Card key={song.id} className="group cursor-pointer hover:shadow-lg transition-shadow">
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center space-x-2 mt-2">
                            ...
                            <Heart className={cn('h-3 w-3', song.isLiked ? 'text-red-500 fill-red-500' : 'text-gray-400')} />
                          </div>
                        </div>
                      </div>
                    </CardContent>
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                {popularGenres.map((genre) => (
                  <Card key={genre.id} className="group cursor-pointer hover:shadow-lg transition-shadow">
                    <CardContent className="p-4">
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">{genre.songCount} songs</p>
                    </CardContent>
                  </Card>
                ))}
              </div>
                ...
                {mockSongs.slice(0, 5).map((song, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      <Heart className={cn('h-4 w-4', song.isLiked ? 'text-red-500 fill-red-500' : 'text-gray-400')} />
